...
describe('Stream.ErizoStream.init', () => {
  ...
  it('should get access to user media when requesting access to video and audio', async () => {
    const localStream = new Stream.ErizoStream(undefined, { audio: true, video: true, data: true });
  ...
  it('should get access to user media when requesting access to video', async () => {
    const localStream = new Stream.ErizoStream(undefined, { audio: false, video: true, data: true });
    const promise = new Promise((resolve) => {
      localStream.on('access-accepted', () => {
        resolve(undefined);
      });
  ...
  it('should get access to user media when requesting access to audio', async () => {
    const localStream = new Stream.ErizoStream(undefined, { audio: true, video: false, data: true });
    const promise = new Promise((resolve) => {
      localStream.on('access-accepted', () => {
        resolve(undefined);
      });
  ...
  it('should get access to user media when requesting access to screen sharing', async () => {
    const localStream = new Stream.ErizoStream(undefined, { screen: true, data: true });
    const promise = new Promise((resolve) => {
      localStream.on('access-accepted', () => {
        resolve(undefined);
      });
